...
$.extend($.validarium, {
	...
	messages: {
		...
		minlength: "Por favor ingresar como mínimo {minlength} characteres.",
		maxlength: "Por favor ingresar no más de {maxlength} characteres.",
		...
		email    : "Por favor ingresar email válido.",
